...
namespace DataAccess.Migrations
{
    ...
    [Migration("20220526190939_filepathaddedtopersonneldocuments")]
    partial class filepathaddedtopersonneldocuments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Concrete.AppUser", b =>
                {
                    ...
                    b.Property<short?>("ConstantSalary")
            ...
            modelBuilder.Entity("Entities.Concrete.Bounty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entities.Concrete.PersonnelDocuments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entities.Concrete.UserBountyDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entities.Concrete.UserCostDto", b =>
                {
                    ...
                    b.Property<string>("ManagerApprovedId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entities.Concrete.UserShiftDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entities.Concrete.UserBountyDto", b =>
                {
                    b.HasOne("Entities.Concrete.Bounty", "Bounty")
                        .WithMany("UserBountyDtos")
            ...
            modelBuilder.Entity("Entities.Concrete.AppUser", b =>
                {
                    b.Navigation("PersonelDocuments");
                });

            modelBuilder.Entity("Entities.Concrete.Bounty", b =>
                {
                    b.Navigation("UserBountyDtos");
                });
